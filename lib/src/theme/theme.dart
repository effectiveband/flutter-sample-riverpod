...
const defaultListPaddingValue = 16.0;

final ThemeData theme = ThemeData(
  useMaterial3: true,
  brightness: Brightness.light,
  primaryColor: const Color(0xffff5722),
  primaryColorLight: const Color(0xffffccbc),
  ...
  toggleableActiveColor: const Color(0xfff4511e),
  secondaryHeaderColor: const Color(0xfffbe9e7),
